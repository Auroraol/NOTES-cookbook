...
- linux的文件系统是采用级层式的树状目录结构，在此结构上的**最上层是根目录“/"**，然后在此目录下在创建其他的目录。
...
2.目前的shutdown/reboot/halt等**命令均已	在关机前进行了sync**
...
![在这里插入图片描述](linux.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQzNjMyNDE0,size_16,color_FFFFFF,t_70-16596238585058.png)
...
1. export变量名=变量值（功能描述:将shell变量输出为环境变量/全局变
